		...
		try { 
		       ...
		       for(int i=0;i<jsonArray.length();i++) {
		           ...
		           //System.out.println("jsonArray"+"   campaignId   "+campaignId+"  campaigncreate_by  : "+campaigncreate_by);
		             //out.println("   campaignId   "+campaignId+"  campaigncreate_by  : "+campaigncreate_by);
		             //out.println("   campaignId   "+campaignId+"  Campaign_Category  : "+jsonobjectcampen.getString("Campaign_Category"));
		           ...
		           //URL url=new URL("http://191.101.165.251/webservice/campaigndatabyid.php?campid="+campaignId+"");
	                 ...
	                 out.println("campaign_click_json_array  length  :"+campaign_click_json_array.length());
									...
									for(int i=0;i<campaignJsonArr.length();i++){
										...
										System.out.println("pagePath : "+json_obj.getString("pagePath"));
											...
											*/
											...
											//out.println("jsonObjectelse : "+jsonObject);
											/*
											String rulr_engine_response=urlconnect("http://34.74.125.253:8082/drools/callrules/carrotrule@xyz.com_LeadAutoConverterNewRule_RuleUri/fire",jsonObject,response);
										    System.out.println(rulr_engine_response);
