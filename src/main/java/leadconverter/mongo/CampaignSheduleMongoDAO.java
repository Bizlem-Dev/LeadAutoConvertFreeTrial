...
public class CampaignSheduleMongoDAO {
		  ...
		  //findCampaignToScheduleFromCampaignListDetails();
		   ...
		   String bodyvalue=URLEncoder.encode(body);
			...
			String campaignaddapiurlparameters = "subject=" + subject + "&fromfield=" + fromfield + "&replyto="
					+ replyto
					+ "&message="+body+"&textmessage=hii&footer="+footer+"&status=draft&sendformat=html&template=&embargo=&rsstemplate=&owner=1&htmlformatted=&repeatinterval=&repeatuntil=&requeueinterval=&requeueuntil=";
			String campaignresponse = sendHttpPostData(campaignaddurl, campaignaddapiurlparameters.replace(" ", "%20").replace("\r", "").replace("\n", ""))
					.replace("<pre>", "");
			*/		
	...
	public static void findCampaignToScheduleFromCampaignDetails(){
	    ...
	    try {
            ...
            LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"Campaign Found To Schedule : "+campaignDetailsCursor.hasNext());
            if(campaignDetailsCursor.hasNext()){
				while(campaignDetailsCursor.hasNext()) {
						...
						free_trail_status=new FreeTrialandCart().checkFreeTrialExpirationStatus(CreatedBy);
						...
						if(free_trail_status.equals("0")){
							...
							updateCampaignStatusInCampaignDetails(collection,Campaign_Id,List_Id,"submitted");// submitted draft
							System.out.println("Sr No. : "+count+" Campaign Id  "+Campaign_Id+"  List Id : "+List_Id);
							LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"Sr No. : "+count+" Campaign Id  "+Campaign_Id+"  List Id : "+List_Id);
							csmdao.activateCampaign(Campaign_Id,List_Id,List_Id,Campaign_Date,campaign_status,"Explore");
            ...
            LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"Total number of Campaign Found To Schedule In CampaignDetails Collection : "+count);
     	   } catch (Exception ex) {
	    ...
	    try {
            ...
            if(campaignListDetailsCursor.hasNext()){
				while(campaignListDetailsCursor.hasNext()) {
						...
						LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"Campaign_Id : "+Campaign_Id
								+" List_Id : "+List_Id+" campaign_status : "+campaign_status
						...
						if(free_trail_status.equals("0")){
							...
							System.out.println("Freetrail Expired for User : "+CreatedBy);
							LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"Freetrail Expired for User : "+CreatedBy);
						}
	...
	public static void updateCampaignStatusInCampaignDetails(MongoCollection<Document> collection,
			String campaign_id,String list_id,String campain_status){
		//ObjectId _id = new ObjectId("4e71b07ff391f2b283be2f95");
	    //ObjectId arrayId = new ObjectId("4e639a918dca838d4575979c");
        Document query = new Document();
	...
	public void activateCampaign(String Campaign_Id,String list_id,String list_id_delete,String Campaign_Date,String campaign_status,
			String category){
		...
		try {
			...
			if (date1.compareTo(date2) == 0) {
		    	...
		    	LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "Date1 is equal to Date2");
		    	
		    	System.out.println("current_campaign_status : "+campaign_status);
		        LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "current_campaign_status : "+campaign_status);
		    	if(!campaign_status.equals("sent")){
		    		LogByFileWriter.logger_info("===========================Active==============================");
		    		LogByFileWriter.logger_info("Active List Id : "+list_id+"  Active Campaign Id : "+Campaign_Id);
		    		LogByFileWriter.logger_info("===========================Active==============================");
					...
					String campaigngetbyid_url_response=sendpostdata(campaigngetbyid_url,campaigngetbyid_url_parameter);
					...
					String status=response_data_json_obj.getString("status");
					  ...
					  if(status.equals("sent") || status.equals("submitted")){
						  ...
						  LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "No need to Anything : "+status);
						  if(status.equals("sent")){
							  ...
							  LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "status_response reque: "+status_response);
						  }
					  }else{
						  
						  System.out.println("Do your stuff here "+status);
						  LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "Do your stuff here "+status);
							...
							campaignlistresponse = this.sendHttpPostData(embargoupdateurl, embargoupdateurlparameters.replace(" ", "%20"))
									.replace("<pre>", "");
							System.out.println("campaignresponse : "+campaignlistresponse);
							LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "campaignresponse : "+campaignlistresponse);
							...
							if(listSubscribersCount(list_id,Campaign_Id)>0){
							   ...
							   LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "status_response : "+status_response);
							}else{
								System.out.println("No Subscribers Found For List Id : "+list_id);
								LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "status_response : "+"No Subscribers Found For List Id : "+list_id);
							}
		    		...
		    		LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "Current Campaign Status is Not equal to Sent");
		    	}
		    	
		        
		    } else if (date1.compareTo(date2) > 0) {
				System.out.println("Date1 is after Date2");
		        LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "Date1 is after Date2");
		    } else if (date1.compareTo(date2) < 0) {
		    	System.out.println("Date1 is before Date2");
		        LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "Date1 is before Date2");
		    }
		} catch (Exception ex) {
	...
	public String campaignStatusUpdate(String id,String status) throws ServletException,
	IOException {
	...
	//listCampaignAdd
	public String campaignListAdd(String listid,String campid) throws ServletException,
	IOException {
	...
	//listCampaignDelete
		public String campaignListDelete(String listid,String campid) throws ServletException,
		IOException {
	...
	//listSubscribersCount
		public int listSubscribersCount(String listid,String campid) throws ServletException,
		IOException {
			    int sub_count=0;
			    try {
	...
	public static String sendHttpPostData(String campaignaddurl,String campaignaddapiurlparameters) throws ServletException,
	IOException {
	...
	public static String sendpostdata(String callurl, String urlParameters) throws ServletException,
			IOException {
					...
					String status=response_data_json_obj.getString("status");
					  ...
					  if(status.equals("sent") || status.equals("submitted")){
						  ...
						  LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "Do your stuff here "+status);
							...
							LogByFileWriter.logger_info("CampaignSheduleMongoDAO: "+"CampaignActivator : " + "embargo updateur response : "+campaignlistresponse);
							// This method call will Activate The Campaign for sending
							if(listSubscribersCount(list_id,Campaign_Id)>0){
							   status_response=this.campaignStatusUpdate(Campaign_Id,"submitted");
							   System.out.println("status_response : "+status_response);
